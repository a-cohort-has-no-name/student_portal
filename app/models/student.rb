...
#test
  ...
  def self.find(id)
    #student = Unirest.get("#{ENV['API_URL']}/#{id}", headers: {"Authorization" => "Token token=#{ENV['API_KEY']}", "X-User-Email" => "#{ENV['API_EMAIL']}"}).body
    student = {id: 1, first_name: "bob", last_name: "bob", email: "bob@b.com", phone_number: 1, bio: "test", linkedin_url: "1.com", twitter_handle: "test1", personal_website: "2.com", resume_url: "3.com", github_url: "4.com", photo: "url?", password_digest: "$2a$10$LTdguNuefm2yVpYhU53qHu3LQ.I88YANtf5VH3AyjisYTmwxFk.9a"}
    Student.new(student)
  end
